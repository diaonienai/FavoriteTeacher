    ...
    <div class="panel panel-default">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
                <%--内容--%>
                <form id="addTeacherForm" action="<%=basePath%>admin/teachers/add" method="post" enctype="multipart/form-data">
                    <p>请在下面录入导师信息,确认无误后点击确定按钮提交!</p>
                    <table class="table table-hover">
                        <tr>
                            <td><label for="teacherName">姓名&nbsp</label><input type="text" name="teacherName"
                                                                               id="teacherName"></td>
                            <td><label for="insName">学院&nbsp</label><input type="text" name="insName" id="insName"></td>
                            <td rowspan="2" align="center">
                                <label for="tIcon"><img id="preview" width="100" height="120"></label>
                                <br>
                                <label for="tIcon" class="btn btn-primary">选择头像</label>
                                <input type="file" id="tIcon" name="tIcon" style="display: none"
                                       onchange="addTeacher.imgPreview(this)"/>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <br/><br/>
                    <div class="center">
                        <button type="button" class="btn btn-danger" onclick="addTeacher.goToTeachers('<%=basePath%>')">
                            取消
                        </button>
